<?php
    ...
    if($id == null){
        ...
        if(isset($_POST['submit'])){
            ...
            $update_query = "UPDATE `blog` SET `blog_title`='$PostTitle',`blog_dtCreated`=current_timestamp,`blog_description`='$PostDesc', `blog_content`='$PostContent' WHERE blog_id='$id'";
...
<html lang="en">
    <head>
        ...
        <title>Modify Selected Blog - FusionTech</title>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <!-- Main page content-->
                    <div class="container-fluid px-4">
                        <form id="updateblogform" action="#" method="POST">
                            <?php
                            ...
                            <div class="row gx-4">
                                <div class="col-lg-8">
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body"><input class="form-control" id="inputPostTitle" name="inputPostTitle" type="text" placeholder="Enter your post title..." value="<?php echo $row["blog_title"] ?>"/></div>
                                    </div>
                                    <div class="card card-header-actions mb-4">
                                        <div class="card-header">Post Description</div>
                                        <div class="card-body"><textarea class="lh-base form-control" name="inputPostDesc" type="text" placeholder="Enter your post Description..." rows="4" id="inputPostDesc"><?php echo $row["blog_description"] ?></textarea></div>
                                    </div>
