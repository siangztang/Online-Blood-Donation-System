...
<html lang="en">
    <head>
      ...
      <title>Seeker List - FusionTech</title>
                        ...
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <div class="collapse show" id="collapseProfile" data-bs-parent="#accordionSidenav">
                                <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPagesMenu">
                                    ...
                                    <a class="nav-link active" href="seeker_index.php">Seeker</a>
                            ...
                            <div class="page-header-content">
                                <div class="row align-items-center justify-content-between pt-3">
                                    ...
                                    <div class="col-12 col-xl-auto mb-3">
                                        ...
                                        <a class="btn btn-sm btn-light text-primary" href="seeker_pdf.php">
    ...
    <script type="text/javascript">
       $(document).on('submit', '#saveUserForm', function(event) {
        ...
        if (seeker_id!='' && username != '' && password != '' && name != '' && blood_type != '' && age != ''&& gender != '' && contact != '' && address != ''&& email != '' ) {

          var form = new FormData();
          form.append("seeker_id", seeker_id);
    ...
    $(document).on('click', '.editbtn',function(event){
      ...
      $.ajax({
        url:"seeker_get_single_user.php",
        data:{id:id},
        type:"post",
        success:function(data)
        {
          var json = JSON.parse(data);
          $('#id').val(json.seeker_id);
          $('#idforshown').val(json.prefix + json.seeker_id);
          $('#trid').val(trid);
          $('#_inputUsername').val(json.seeker_username);
          $('#_inputPassword').val(json.seeker_password);
          $('#_inputName').val(json.seeker_name);
          $('._inputBloodType').selectpicker('val', [json.seeker_blood_type]);
          $('#_inputAge').val(json.seeker_age);
          $('._inputGender').selectpicker('val', [json.seeker_gender]);
          $('#_inputContact').val(json.seeker_contact);
          $('#_inputAddress').val(json.seeker_address);
          $('#_inputEmail').val(json.seeker_email);
          var date = json.latest_request_date.split(' ');
    ...
    $(document).on('submit', '#updateUserForm',function(){
      ...
      var latest_request_date = $('#_inputDate').val();
      var image = $('#_inputImage')[0].files[0];
        ...
        form.append("address", address);
        form.append("email", email);
        form.append("latest_request_date", latest_request_date);
        form.append("image", image);


         var settings = {
            "async": true,
            "url": 'seeker_update_user.php',
            "type": "POST",
            "processData": false,
            "contentType": false,
            "mimeType": "multipart/form-data",
    ...
    $(document).on('click', '.deleteBtn', function(event) {
      ...
      Swal.fire({
      title: 'Are you sure?',
      text: "Delete Profile: SKR" + id ,
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
      confirmButtonText: 'Yes, delete: SKR' + id
    }).then((result) => {
      if (result.isConfirmed) {
        $.ajax({
          url: "seeker_delete_user.php",
          data: {
            id: id
          },
          type: "post",
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Add New Seeker</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <form id="saveUserForm" action="javascript:void();" class="was-validated" method="post">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary">Save as New Seeker</button>
          </div>
        </div>
        </form>
      </div>
    </div>
    <!-- end add seeker modal -->
    ...
    <div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" aria-hidden="true" data-bs-keyboard="false">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Modify Selected Seeker</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          ...
          <div class="modal-body">
            ...
            <div class="mb-3 row">
              <label for="id" class="col-sm-3 col-form-label">Seeker ID: </label>
              <div class="col-sm-9">
