...
<h1 class="heading" style='color:#751919;'>Donation History </h1>
...
$servername = "localhost";
      ...
      $sql = "SELECT * FROM blood where donor_username='$donor_username' ORDER BY donate_date_time DESC " ;
          ...
          ?>
                <li>
                   <div class="timeline-content">
                     <h3 class="date"><?php echo $row ["donate_date_time"];?></p></h3>
                     <h1><?php echo $row ["blood_group"];?></p></h1>
                     <p>
                     <div class="h3-search" style="font-size:18px;line-height:30px">
                        Blood Volume:  &nbsp;&nbsp;<b><?php echo $row ["blood_volume"];?></p></b>
                        Haemoglobin Content:  &nbsp;&nbsp;<b><?php echo $row ["hemoglobin_content"];?></p></b>
                        Blood Status:  &nbsp;&nbsp;<b><?php echo $row ["blood_status"];?></p></b><br>
                     </div>
                     </p>
                   </div>
                 </li>             
