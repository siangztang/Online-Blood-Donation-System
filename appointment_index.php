...
<html lang="en">
                ...
                <nav class="sidenav shadow-right sidenav-light">
                    <div class="sidenav-menu">
                        <div class="nav accordion" id="accordionSidenav">
                            ...
                            <a class="nav-link active" href="appointment_index.php">
                            ...
                            <div class="page-header-content">
                                <div class="row align-items-center justify-content-between pt-3">
                                    ...
                                    <div class="col-12 col-xl-auto mb-3">
                                        ...
                                        <a class="btn btn-sm btn-light text-primary" href="appointment_pdf.php">
    ...
    $(document).ready(function() {
      $('#datatable').DataTable({
        ...
        'order': [],
        'ajax': {
          'url': 'appointment_fetch_data.php',
          'type': 'post',
        },
        "aoColumnDefs": [{
            "bSortable": false,
    ...
    <script type="text/javascript">
       $(document).on('submit', '#saveUserForm', function(event) {
        ...
        if ( donor != '' && centerID != '' && date_time != '' && appointment_status != '') {
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body ">
            ...
            <div class="mb-3 row">
              <label for="inputCenter" class="col-sm-3 col-form-label">Center: </label>
              <div class="col-sm-9">
                <select name="inputCenter" id="inputCenter" class="inputCenter selectpicker form-control" data-live-search="true" title="Choose one of the following..." required>                
                  <?php
                  while($row = mysqli_fetch_assoc($centerAddQuery))
                  {
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-9">
                <select name="_inputCenter" id="_inputCenter" class="_inputCenter selectpicker form-control" data-live-search="true" title="Choose one of the following..." required>                
                  <?php
